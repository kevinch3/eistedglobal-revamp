...
export class ApiService {
  ...
  createParticipant(p: ParticipantInput): Observable<Participant> {
    return this.http.post<Participant>(`${this.base}/participants`, p);
  }
  updateParticipant(id: number, p: ParticipantInput): Observable<Participant> {
  ...
  createCategory(c: CategoryInput): Observable<Category> {
    return this.http.post<Category>(`${this.base}/categories`, c);
  }
  updateCategory(id: number, c: CategoryInput): Observable<Category> {
  ...
  updateEdition(year: number, data: EditionInput): Observable<Edition> {
  ...
  createCompetition(c: CompetitionInput): Observable<Competition> {
    return this.http.post<Competition>(`${this.base}/competitions`, c);
  }
  updateCompetition(id: string, c: CompetitionUpdate): Observable<Competition> {
  ...
  createRegistration(r: RegistrationInput): Observable<Registration> {
  ...
  createWork(w: WorkInput): Observable<Work> {
    return this.http.post<Work>(`${this.base}/works`, w);
  }
  updateWork(id: number, w: WorkUpdate): Observable<Work> {
